...
class Twitter extends TwitterOAuth {
    ...
    public function Twitter() {
       ...
       // {
       //  define('TWITTER_APP_KEY','');
       //  define('TWITTER_APP_SECRET','');
       //  define('TWITTER_APP_REDIRECT_URI','');
       // }
        try
        {
        $ci =& get_instance();
    ...
    {
    return    $request_token =$this->oauth2('oauth2/token',array('grant_type'=>'client_credentials'));
      
    }
    public function destroy_bearer_token(){
      $this->tw_post('oauth2/invalidate_token');
    }
