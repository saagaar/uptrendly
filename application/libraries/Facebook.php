...
class Facebook{
    ...
    private $permissions=array('email','manage_pages','pages_show_list');
    /**
     * @var FB
     */
    private $fb;
        ...
        if((defined('FACEBOOK_APP_KEY') && defined('FACEBOOK_APP_SECRET')))
       {
        ...
        if (!isset($this->fb))
        {
            $this->fb = new Facebook\Facebook([
               ...
               'persistent_data_handler' => 'memory', //fb sdk uses native session this function is used to rewrite fb session with codeigniter session for session ussage
