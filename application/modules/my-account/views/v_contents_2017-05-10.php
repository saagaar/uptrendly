...
<div class="mid-part">
  ...
  ?>
    <li role="presentation"><a href="#youtulee" aria-controls="settings" role="tab" data-toggle="tab">Youtulee<span class="pull-right round_btn btn-youtulee"> <img src="<?php echo site_url('/'.USER_IMG_DIR.'push.png')?>" alt="" width="50px"> 
     </span></a></li>
   <?php 
     endif;
    ...
    if(array_key_exists(TUMBLRMEDIAID,$allcamp)):
         ...
         foreach ($allcamp[TUMBLRMEDIAID] as $key => $value) {
          ...
          ?>
           ...
           <li>
             <div class="col-xs-3"><p>Content Title</p><h3><?php echo $value->name;?></h3></div>
            <div class="col-xs-3"><p>Views</p><h3><?php //echo $content['viewCount']?></h3></div>
            <div class="col-xs-3"><p>Like Count</p><h3><?php// echo $content['likeCount']?></h3></div>
            <div class="col-xs-3"><p>Avg. CPE</p><h3>$0.00</h3></div>
           </li>
