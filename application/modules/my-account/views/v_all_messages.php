    <div class="msz_filter_sec a_message">
          ...
          <div class="row">
            <div class="col-md-3 col-sm-4"> <!-- required for floating --> 
              ...
              <ul class="list-unstyled msz_menu messagemenu">
               <li class="<?php if($view=='create_message') echo 'active';?>"><a href="#create_msz" data-type="create_message" class="messagetype " data-toggle="tab">Create Message</a></li> 
                <li class="<?php if($view=='inbox') echo 'active';?>">
                  <a href="#inbox_msz" data-type="inbox" class="messagetype" data-toggle="tab">
                    <span>Inbox</span>
                  </a>
                </li>
                <li class="<?php if($view=='sent') echo 'active';?>">
            ...
            <div class="col-md-9 col-sm-8 msz_sec message_list">
              ...
              <div class="tab-content messages">
                <div class="tab-pane fade in <?php if($view=='create_message') echo 'active';?> " id="create_msz" data-type="create_message">
                   ...
                   <div class="col-sm-6 control-group">
                      <select name="productid" id="productid" class="form-control">
                       <option value="0">General</option>
                        <?php 
                        if(is_array($active_products) && count($active_products)>0):
                          foreach($active_products as $eachproduct):?>
