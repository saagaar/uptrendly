<ul class="list-unstyled product_listing campaigns_list">
  <?php 
                   ...
                   if(is_array($reports) && count($reports)>0)
                   {
                    ...
                    // {
                    //   // $reports[$data->product_name]=$data;
                    // }
  ...
  <li>
    <div class="row">
      ...
      <div class="col-xs-7 col-sm-9 fourstep">
        <h4><a href="#" id="<?php echo $productdata['product_id'];?>_product_name"><?php echo $productdata['name'];?></a>
          <?php 
                                    $socialmedia=array();
        ...
        <div class="row">
          <div class="col-xs-6 col-sm-3">
            <h5>Likes <span><?php  if($productdata['likes']) echo $productdata['likes'];else echo 0;?></span></h5>
            <h5>Tweet <span><?php  if($productdata['tweet']) echo $productdata['tweet'];else echo 0;?></span></h5>
          </div>
          <div class="col-xs-6 col-sm-3">
            <h5>Comment123 <span><?php  if($productdata['comments']) echo $productdata['comments'];else echo 0;?></span></h5>
            <h5>Views <span><?php  if($productdata['comments']) echo $productdata['comments'];else echo 0;?></span></h5>
          </div>
         <div class="col-xs-6 col-sm-4 col-md-2">
            <h5>Share <span><?php  if($productdata['share']) echo $productdata['share'];else echo 0;?></span></h5>
          <!--   <h5>CPE <span><?php echo $cpe;?></span></h5> -->
          </div>
          <div class="col-xs-6 col-sm-3">
            <h5>Subscribe <span><?php 
            if($productdata['subscribe']) echo $productdata['subscribe'];else echo 0;?></span></h5>
           <!-- <h5>CLICKS <span><?php echo $click;?></span></h5> -->
          </div>
          <div class="col-xs-6 col-sm-3">
            <h5>Followers <span><?php  if($productdata['follow']) echo $productdata['follow'];else echo 0;?></span></h5>
          <!--  <h5>CTR <span><?php echo $ctr ;?></span></h5> -->
          </div>
        </div>
         <div class="row">
           <h5>Social media Link<span><a href="http://facebook.com/<?php echo $productdata['upload_link']?>">http://facebook.com/<?php echo $productdata['upload_link']?></a></span></h5> 
         </div>
       ...
       <!--    <a href="" data-productid="<?php echo $productdata['product_id'];?>" class="btn btn-primary sponsordetail" id="<?php echo $productdata['product_id'];?>_sponsordetailid">
       <i class="fa fa-th-list"></i> Detail</a> -->
      <a class="btn btn-sm btn-default pull-right " href="<?php echo site_url('/'.MY_ACCOUNT.'download_report')?>" data-productid="<?php echo $productdata['product_id'];?>" ><i class="fa fa-pencil"></i> Download Report</a> </div>
      </div>
    </div>
  </li>
  <?php 
