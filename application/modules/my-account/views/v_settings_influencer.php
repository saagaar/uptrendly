...
if(is_array($profession) && count($profession)>0)
{
 ...
 $mediaassoc=array();
  if(count($mediadetail)>0){
   ...
   $mediaarray=array();
  if(count($allmediaactive)>0){
    foreach($allmediaactive as $activemedia)
    {
      $mediaarray[]=$activemedia->id;
  ...
  <div class="col-xs-12">
    <div role="tabpanel" class="top-filter">
      <ul class="list-unstyled msz_menu">
        ...
        <li id="creatorprofile_edit" <?php if($view=='general'):?>class="active"<?php endif;?> data-view="general"> <a href="#form1" data-toggle="tab"> <span>Edit Profile
              ...
              <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                <div class="panel">
                  ...
                  <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                    <div class="panel-body">
                      ...
                      $proffessionname=$this->general->get_member_profession($this->session->userdata(SESSION.'user_id'));
                       
                       ?>
                          <label>Profession</label>
                          <input type="text" class="form-control no-radius" value="<?php echo trim($proffessionname,',')?>" readonly>
                        </div>
                        <div class="col-sm-3 col-xs-6">
                  ...
                  <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                    <div class="panel-body">
                        <?php
                             ...
                             foreach($mediaarray as $eachmedia): 
                              if(defined('FACEBOOKMEDIAID') && $eachmedia==FACEBOOKMEDIAID ):
                               ?>
                        ...
                        <?php
                              ...
                              ?>
                        <p> <a href="<?php echo $eachdata?>" class="s_url" target="_blank"><?php echo $eachdata?></a> </p>
                        <?php
                               endforeach;
                            endif;
                            endforeach;?>
                ...
                <div class="panel">
                  ...
                  <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                    <div class="panel-body">
                      <div class="row" data-toggle="tooltip" data-placement="top" title="This detail will be confidential">
              ...
              <div class="form">
                ...
                <div class="col-sm-7"> 
                  ...
                  <div class="form-group">
                    ...
                    <span class="rc_block">
                      <input type="radio" name="gender" <?php  if($gender=='m') echo 'checked';?> value="m">
                      <span class="rdo_txt">Male</span>
                    </span>
                    <span class="rc_block">
                      <input type="radio" name="gender" <?php  if($gender=='f') echo 'checked';?> value="f">
                      <span class="rdo_txt">Female</span>
                    </span>
                    <span class="rc_block">
                      <input type="radio" name="gender" <?php  if($gender=='o') echo 'checked';?> value="o">
                      <span class="rdo_txt">Others</span>
                    </span>
                  ...
                  ?>
                   <!--  <select name="profession" multiple="multiple" id="inputprofession" class="form-control">
                   ...
                   <!--   <option <?php if($eachproffession->id==$professionid)  echo 'selected ';?>value="<?php echo $eachproffession->id?>"><?php echo $eachproffession->profession;?></option> -->
                    <span class="rc_block">
                      <input type="checkbox" <?php if(in_array($eachproffession->id,$professionarr)) echo 'checked' ;?> name="profession[]" value="<?php echo $eachproffession->id?>">
                      <span class="rdo_txt"><?php echo $eachproffession->profession;?></span>
                    </span>
                     <?php endforeach;?>
                  ...
                  <div class="form-group">
                    ...
                    <span class="rc_block">
                      ...
                      <span class="rdo_txt"><?php echo $eachcategory['name'];?></span>
                    </span>
