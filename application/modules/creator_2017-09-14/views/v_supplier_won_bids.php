      ...
      <div class="modal-body">
        <form method="post" action="<?php echo site_url('/'.MY_ACCOUNT.'saverating');?>" class="saverating"  enctype="multipart/form-data">
          <div class="form-group">
            ...
            <label>Rating</label>
            <div class="rating"> <span><i class="fa fa-star ratestar" id="1-rate" ></i></span> <span><i class="fa fa-star ratestar" id="2-rate"></i></span> <span><i class="fa fa-star ratestar" id="3-rate"></i></span> <span><i class="fa fa-star ratestar" id="4-rate"></i></span> <span><i class="fa fa-star ratestar" id="5-rate"></i></span> </div>
          </div>
          <div class="form-group">
