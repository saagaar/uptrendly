            ...
            {               
              ...
              <div class="text-center">
                      <a href="#" data-productid="<?php echo $sponsitem['product_id'];?>" data-btntype="add" data-media="<?php echo $sponsitem['media'];?>" class="btn btn-success sendproposal" id="sponsorshipproposal_<?php  echo $sponsitem['product_id'] ?>">Send Proposal</a> 
                       <a href="#" data-productid="<?php echo $sponsitem['product_id'];?>" class="btn btn-primary sponsordetail" id="<?php echo $sponsitem['product_id'];?>_sponsordetailid" >Detail</a>
                ...
                <?php 
                    ...
                    <?php }
                          ?>
                           ...
                           <?php if(in_array(VINEMEDIAID,$usermedia))
                          { ?>
                             <div class="col-xs-1 smedia hidden" id="vinemedia"><a data-productid="<?php echo $sponsitem['product_id'];?>"   data-mediaid="<?php echo VINEMEDIAID?>" href="#" data-medianame="vine" class="btn btn-block mediabrand btn-success"><i class="fa fa-vine "></i></a></div>
                    <?php }
                          ?>
                  ...
                  Sponsored content must stay up for at least six months.</p>
                    ...
                    <div class="body">
                       ...
                       $data['socialmedia']=$socialmedia;
                        ...
                        <<div></div> class=" col-sm-12 bottom_content">
                            <div class="col-sm-12">
