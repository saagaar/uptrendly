            ...
            { 
              ...
              <!-- <hr>    -->
                  <div class="text-center">
                      ...
                      <a href="#" data-productid="<?php echo $sponsitem['product_id'];?>" data-btntype="edit" data-media="<?php echo $sponsitem['media'];?>" class="btn btn-success sendproposal" id="sponsorshipproposal_<?php  echo $sponsitem['product_id'] ?>">Send Proposal</a> 
  ...
  <script>
    $(function(){
      ...
      console.log('#sponsorshipproposal_<?php echo $this->session->userdata("selectedproduct")?>');
    });
  </script>
  <?php 
