...
<div class="tab-content">
  ...
  <div role="tabpanel" class="tab-pane fade " id="hired">
    <div class="col-sm-12">
      <h5 class="text-center result_ttl"><b>No Creators Hired</b> <br>
        This list shows all the creators you've hired once they've completed some content for you.</h5>
      <!--  <ul class="list-unstyled product_listing">
               <li>
                 <div class="row">
                   <div class="col-xs-5 col-sm-3"><a class="image" href=""><img src="<?php echo base_url().USER_IMG_DIR; ?>baby.jpg"></a></div>
               ...
               <li>
                 <div class="row">
                   <div class="col-xs-5 col-sm-3"><a class="image" href=""><img src="<?php echo base_url().USER_IMG_DIR; ?>bab.jpg"></a></div>
                   <div class="col-xs-7 col-sm-9">
               ...
               <li>
                 <div class="row">
                   <div class="col-xs-5 col-sm-3"><a class="image" href=""><img src="<?php echo base_url().USER_IMG_DIR; ?>ba.jpg"></a></div>
                   <div class="col-xs-7 col-sm-9">
