        ...
        <div class="col-xs-7 col-sm-9">
          ...
          <div class="row">
            <div class="col-md-4 col-sm-4 col-xs-6">
              <h5>REACH <span><?php echo $percreator['total_media_reach']?></span></h5>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-6">
              <h5>Ceiling Likes <span><?php echo $percreator['ceiling_likes'];?></span></h5>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-6">
              <h5>Cost<span><?php echo DEFAULT_CURRENCY_SIGN.'. '. $percreator['price'];?></span></h5>
            </div>
         <!--    <div class="col-md-4 col-sm-4 col-xs-6">
              <h5>Gender <span>
            ...
            <div class="col-md-4 col-sm-4 col-xs-6">
              <h5>Profession <span><?php 
              $profesionmember=$this->general->get_member_profession($percreator['user_id']);
              echo $profesionmember;
          ...
          <div class="text-uppercase"> 
            <a href="#" class="btn btn-sm btn-primary invitecreator" data-userid="<?php echo $percreator['user_id'];?>">
              <i class="fa fa-paper-plane "></i> Inquire
            </a> 
              <a href="<?php echo site_url('/'.BRAND.'profile/'. $percreator['user_id'])?>" class="btn btn-sm btn-success">
                <i class="fa fa-camera"></i> Profile
            </a> 
          
          </div>
          <?php endif;?>
            <a href="javascript:void(0)" data-userid="<?php echo $percreator['user_id']?>" class="btn btn-sm btn-default pull-right viewsocialmedia" >
...
<div id="socialmedialinks" class="modal fade" role="dialog">
      ...
      <div class="modal-body">
        <div class="panel-body">
                        <?php
                             ...
                             foreach($mediaassoc as $key=>$eachmedia): 
                               $mediaid=$eachmedia->id;
                              if(defined('FACEBOOKMEDIAID') && $mediaid==FACEBOOKMEDIAID ):
                               ?>
                            <label  id="media<?php echo $eachmedia->id?>" class="mediadetail hidden"> <span class="pull-right round_btn facebook"> <i class="fa fa-facebook-f"></i> </span> </label>
                        <?php
                              endif;
                               if(defined('INSTAGRAMMEDIAID') &&  $mediaid==INSTAGRAMMEDIAID ):
                              ?>
                          <label  id="media<?php echo $eachmedia->id?>" class="mediadetail hidden"> <span class="pull-right round_btn instagram"> <i class="fa fa-instagram"></i> </span> </label>
                        <?php
                              endif;
                               if(defined('TWITTERMEDIAID')  &&  $mediaid==TWITTERMEDIAID ):
                              ?>
                        <label id="media<?php echo $eachmedia->id?>" class="mediadetail hidden"> <span class="pull-right round_btn twitter"> <i class="fa fa-twitter-square"></i> </span> </label>
                        <?php
                              endif;
                               if(defined('YOUTUBEMEDIAID') &&  $mediaid==YOUTUBEMEDIAID ):
                              ?>
                        <label  id="media<?php echo $eachmedia->id?>" class="mediadetail hidden"> <span class="pull-right round_btn youtube"> <i class="fa fa-youtube-play"></i> </span> </label>
                        <div class="addlink">
                        </div>
                        <?php
                              endif;
...
<script>var socialmedialink='<?php echo site_url(MY_ACCOUNT."get_socialmedia_profile");?>'</script>