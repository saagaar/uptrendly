  ...
  <li>
    <div class="row">
      ...
      <div class="col-xs-7 col-sm-9 fourstep">
        ...
        <?php if($account_menu_active=='campaigns'):?>
                <div class="text-uppercase"> 
                      <a href="<?php echo site_url('/'.BRAND.'getproposalbyproduct/'.$productdata['product_code']);?>" class="btn  btn-blue"> <i class="fa fa-file-text"></i> View Progress
                      </a> 
                      <a href="" data-productid="<?php echo $productdata['product_id'];?>" class="btn btn-primary sponsordetail" id="<?php echo $productdata['product_id'];?>_sponsordetailid"> <i class="fa fa-th-list"></i> Detail
                      </a> 
                    <!--    <a class="btn btn-sm btn-default pull-right btn-danger deletebtn" href="<?php echo site_url('/'.BRAND.'close_campaign/'.$productdata['product_id'])?>" ><i class="fa fa-times"></i> Close Campaign -->
                      <a class="btn btn-sm btn-default pull-right btn-danger deletebtn" href="<?php echo site_url('/'.BRAND.'delete_campaign_post/'.$productdata['product_id'])?>" data-productid="<?php echo $productdata['product_id'];?>" ><i class="fa fa-trash"></i> Delete
                      </a> 
         ...
         <?php 
          ...
          ?>
             <a href="<?php echo site_url('/'.BRAND.'reports/'.$productdata['product_id']);?>" class="btn  btn-blue"> <i class="fa fa-file-text"></i> View Report
                      </a>
        <?php 
         endif;?>
      </div>
