	...
	public function delete($id = 0)
	{
        ...
        if(array_key_exists('delete-bidpackage', $this->admin_permissions)):
			...
			if($query->num_rows() > 0) 
			{
				...
				if(LOG_ADMIN_ACTIVITY == 'Y')
				{
					$this->general->log_admin_activity(array('user_id' => $this->session->userdata(ADMIN_LOGIN_ID), 'user_type' =>  $this->session->userdata(ADMIN_USER_TYPE), 'module' => 'Bidpackage', 'module_desc' => 'Bidpackage Deleted', 'action' => 'Delete', 'extra_info' => 'bidpackage id: '.$id));
				}
