                          ...
                          <li>
                            <div class="row">
                               ...
                               <?php 
                                ...
                                <a href="<?php echo site_url('/'.BRAND.'getproposalbyproduct/'.$productdata['product_id']);?>" class="btn btn-sm btn-primary"><i class="fa fa-file-text"></i> View Proposals</a>
  ...
  <div class="modal-dialog modal-lg" role="document">
    ...
    <div class="row"> 
      <div class="col-sm-4 text-center pop_left"><figure><img id="productimg" src=""></figure><h4 id="product_name"></h4>
        <a href="#" class="btn btn-warning edit_campaign" data-action="<?php echo site_url('/'.BRAND.'getproductbyid')?>" data-productid="<?php echo $productdata['product_id'];?>">Edit Campaigns</a>
      </div>
      <div class="col-sm-8">
