          ...
          <fieldset>
            <ul class="frm">
              ...
              <li>
                ...
                <input size="50" class="inputtext" type="text" id="credits" name="credits" value="<?php echo set_value('credits');?>" placeholder="" />  
                  <?php echo form_error('credits'); ?> 
                
             </li>
             <li>
                <label>Package  Cost<span>*</span> :</label>
                <input size="50" class="inputtext" type="text" id="amount" name="amount" value="<?php echo set_value('amount');?>" />  
              ...
              <li>
                ...
                <div>
                  <input  type="text" id="valid_months" name="valid_months" value="<?php echo set_value('valid_months');?>" style='display:inline;' />  Months
                  <?php echo form_error('valid_months'); ?> 
                  <input  type="text" id="valid_days" name="valid_days" value="<?php echo set_value('valid_days');?>"  style='display:inline;'  />  Days
             ...
             <li>
                ...
                <input name="display" type="radio" value="Yes" checked="checked" />Yes
                <input name="display" type="radio" value="No" <?php if(isset($_POST['dispaly']) && $_POST['display'] == 'No'){ echo 'checked="checked"';}?> />No
