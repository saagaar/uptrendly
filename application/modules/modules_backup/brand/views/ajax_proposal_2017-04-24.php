<div class="proposal_stat">
			...
			<li class="clearfix">	
				...
				<?php }
					...
					{  ?>
						...
						<?php elseif($proposalscol['status']==0):?>
				...
				if($proposalscol['bid_id']==$proposalscol['draft']) : 
					...
					?>
					<a class="btn btn-sm btn-warning" href="javascript:void(0)" data-toggle="modal" data-target="#v_verify_upload"><i class="fa fa-hourglass"></i> Verify Upload</a>
				  	<?php endif;
 ...
 <div class="modal fade" id="v_draft" role="dialog">
   ...
   <div class="modal fade" id="v_verify_upload" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close" style=" margin:8px;"><span aria-hidden="true" class="fa fa-times"></span></button>
	<form id="communication" method="post">
        <div class="row no-marg-right">
        	...
        	<div class="col-sm-8">
        		<div class="right_draft_sec">
    				...
    				<form name="draft_promotion" id="draft_upload" action="#">
    				<div class="btn_sec">
    				<input type="hidden" name="bid_id" value="<?php echo $proposalscol['bid_id']?>">
