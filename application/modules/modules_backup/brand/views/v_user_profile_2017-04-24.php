...
<?php
    ...
    foreach($media[INSTAGRAMMEDIAID] as $instaprofile):
       ...
       //   $retweet=$postdetail->retweet_count;
      ?>
      <a class="modalprofile" href="javascript:void(0)" data-description="<?php// echo $description;?>" data-likes="<?php //echo $likes ?>" data-views="<?php// echo $views;?>" data-comments="<?php// echo $comments;?>" data-url="<?php echo $instaprofile->url;?>" data-media="instagram" data-toggle="modal">
             <?php if($align%2==0): ?>
