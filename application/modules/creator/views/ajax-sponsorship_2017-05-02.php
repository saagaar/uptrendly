            ...
            { 
              ...
              $url=$this->general->create_custom_link( $sponsitem['product_id'],$this->session->userdata(SESSION.'user_id'));?>
                ...
                <div class="error-message hidden" style="color:red"></div>
                 <a href="<?php echo  $url;?>" onClick="trackOutboundLink('<?php echo $url;?>',<?php echo  $sponsitem['product_id'];?>)"><?php //echo $url;?></a>
                  ...
                  <a href="#" data-productid="<?php echo $sponsitem['product_id'];?>" class="btn btn-primary sponsordetail" id="<?php echo $sponsitem['product_id'];?>_sponsordetailid" onClick="ga('send',  'event','sponsoritemdetail','click','<?php echo 'detailbutton_'.$sponsitem['product_id']?>')">Detail</a> 
                       <?php if((isset($sponsitem['bid_status'])) && ($sponsitem['bid_status']=='1' || $sponsitem['bid_status']=='2') && ($sponsitem['draft_accept']=='0' || $sponsitem['draft_accept']=='' || $sponsitem['draft_accept']=='2')){
                        ?>
                        <a href="#" data-productid="<?php echo $sponsitem['product_id'];?>" data-bidid="<?php echo $sponsitem['bid_id']?>" class="btn btn-primary draftpopupbtn" id="<?php echo $sponsitem['product_id'];?>_sponsordraft" >Send Draft</a>
                        <?php }
                         if((isset($sponsitem['bid_status'])) && ($sponsitem['bid_status']=='2' || $sponsitem['bid_status']=='1') && ($sponsitem['draft_accept']=='1' )){
                          // echo 'here'  
                        ?>
                        <a href="#" data-productid="<?php echo $sponsitem['product_id'];?>" data-bidid="<?php echo $sponsitem['bid_id']?>" class="btn btn-primary mediatrack" id="<?php echo $sponsitem['product_id'];?>_sponsordetailid" >Social Media Track id</a>
                        <?php }
                        ?>
                  </div> 
              <!-- </hr> -->
      ...
      <?php 
     echo $this->session->userdata('popup_media');echo  $this->session->userdata("selectedproduct");exit;
