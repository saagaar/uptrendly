  ...
  <div class="log-form">
    <div class="inbox_content">
      ...
      <table class="table">
        <tbody>
          <tr>
            <td colspan="2"><form id="communicationwithsupplierform" action="<?php echo site_url('/'.MY_ACCOUNT.'send_message/'.$product_id.'/'.$bid_id); ?>" method="post" class="reply" enctype="multipart/form-data">
          ...
          <tr>
            ...
            if(count($communicationdata)){
              ...
              <div class="user_a">
                ...
                <div class="col-md-10 dtl"> <span class="tym"><?php echo $date.' '.$time;?></span> <span class="u_name"><?php echo $chat->username?></span>
                  <p> <em style="<?php echo $widths;?>"> <?php echo $chat->message;?> </em>
                    <?php if($chat->file_saved){?>
                    <a href="<?php echo site_url('/download/message_attachment/'.$chat->attachmentid); ?>"> <i class="fa fa-cloud-download" aria-hidden="true"></i></a>
                    <?php } ?>
                  </p>
                </div>
                <?php 
                ...
                <div class="user_b text-right">
                  <div class="col-md-10 dtl"> <span class="u_name"><?php echo $chat->username;?></span> <span class="tym">10:47 AM</span>
                    <p> <em style="<?php echo $widths;?>"> <?php echo $chat->message;?> </em>
                      <?php if($chat->file_saved){?>
                      <a href="<?php echo site_url('/download/message_attachment/'.$chat->attachmentid); ?>"> <i class="fa fa-cloud-download" aria-hidden="true"></i></a>
                      <?php } ?>
