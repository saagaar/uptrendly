 <input type="hidden" class="form-control" id="productsid" name="productid" value=""/>
                ...
                <div class="facebookmain proposalform hidden">
                        ...
                        <div class="col-sm-12 clearfix">
                                <div class="col-sm-1 no-pad-sides marg-bottom-10">
                                 ...
                                 <div class="col-sm-4">
                                  <input type="number" class="form-control bid_amount facebookelement proposalformelement" id="facebook_bid_amount" placeholder="Place your fee" name="facebook[bid_amount]" disabled="disabled" value="" />                              
                                </div>
                                <div class="col-sm-6 pad-sides-5 no-pad-left">
                ...
                <div class="youtubemain proposalform hidden">
                        <div class="col-sm-12 clearfix">
                                <div class="col-sm-1 no-pad-sides marg-bottom-10">
                                 ...
                                 <div class="col-sm-4">
                                  <input type="number" class="form-control bid_amount youtubeelement proposalformelement" disabled="disabled" id="youtube_bid_amount" placeholder="Place your fee" name="youtube[bid_amount]" value="" />                              
                                </div>
                                <div class="col-sm-6 pad-sides-5 no-pad-left">
                                    <div class="input-group delivery_date date">
                                        <input type="text" class="form-control delivery_date youtubeelement proposalformelement" disabled="disabled" id="youtube_delivery_date" readonly name="youtube[delivery_date]" placeholder="Delivery Date" /><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                    </div>
                                </div>
                                <div class="col-sm-1 no-pad-sides">
                                    <i class="fa fa-times"> </i>
              ...
              <div class="instagrammain proposalform hidden">
                        <div class="col-sm-12 clearfix">
                                <div class="col-sm-1 no-pad-sides marg-bottom-10">
                                 ...
                                 <div class="col-sm-4">
                                  <input type="number" class="form-control bid_amount  instagramelement proposalformelement" disabled="disabled" id="instagram_bid_amount" placeholder="Place your fee" name="instagram[bid_amount]" value="" />                              
                                </div>
                                <div class="col-sm-6 pad-sides-5 no-pad-left">
                                    <div class="input-group delivery_date date">
               ...
               <?php endif;
                ...
                <div class="twittermain proposalform hidden">
                        <div class="col-sm-12 clearfix">
                                <div class="col-sm-1 no-pad-sides marg-bottom-10">
                                    <div class="text-center">
                                      <input type="hidden" class="form-control twitterelement proposalformelement" disabled="disabled" id="twitter_mediaid" name="twitter[mediaid]" value="<?php echo TWITTERMEDIAID;?>" />
                                        <span id="proposalmediaicon" class="round_btn twitter round-icon proposalmediaicon"><i class="fa fa-twitter-square"></i></span>
                                    </div>
                                </div>
                                 <div class="col-sm-4">
                                  <input type="number" class="form-control bid_amount  twitterelement proposalformelement" disabled="disabled" id="twitter_bid_amount" placeholder="Place your fee" name="twitter[bid_amount]" value="<?php echo TWITTERMEDIAID;?>" />                              
                                </div>
                                <div class="col-sm-6 pad-sides-5 no-pad-left">
                                    <div class="input-group delivery_date date">
                                ...
                                <div class="col-sm-1 no-pad-sides marg-bottom-10">
                                    <div class="text-center">
                                      <input type="hidden" class="form-control youtuleeelement proposalformelement" disabled="disabled" id="youtulee_mediaid" name="youtulee[mediaid]" value="<?php echo YOUTULEEMEDIAID;?>" />
                                       <span  id="proposalmediaicon" class="round_btn youtulee proposalmediaicon btn-youtulee">
                 ...
                 <div class="tumblrmain proposalform hidden">
                        <div class="col-sm-12 clearfix">
                                <div class="col-sm-1 no-pad-sides marg-bottom-10">
                                 ...
                                 <div class="col-sm-4">
                                  <input type="number" class="form-control bid_amount  tumblrelement proposalformelement" disabled="disabled" id="tumblr_bid_amount" placeholder="Place your fee" name="tumblr[bid_amount]" value="" />                              
                                </div>
                                <div class="col-sm-6 pad-sides-5 no-pad-left">
                                    <div class="input-group delivery_date date">
