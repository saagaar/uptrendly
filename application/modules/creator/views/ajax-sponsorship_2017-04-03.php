          ...
          if(count($sponsorships)>0)
          {
            ...
            { 
              ...
              ?>
              <div class="grid-item">
              <span class="btn btn-info price_range"><?php echo DEFAULT_CURRENCY_SIGN.$sponsitem['price_range'];?></span> 
              ...
              ?>
              <figure>
              <img id="<?php echo $sponsitem['product_id'];?>_productimg" src="<?php echo  site_url(PRODUCT_IMAGE_PATH.$image)?>">
              </figure>
              <div class="grid_inn">
                    <h4>  
                        <a href="#" id="<?php echo $sponsitem['product_id'];?>_product_name"><?php echo $sponsitem['product_name'];?></a> 
                    ...
                    <p id="<?php echo $sponsitem['product_id'];?>_description">
                         <?php echo $sponsitem['description'];?>
                    </p>
              </div> 
              <!-- <hr>    -->
              <script type="text/javascript">
                 ...
                 ga('send', 'event', 'outbound', url,"<?php echo 'button_'.$sponsitem['product_id']?>" , {
                   'transport': 'beacon',
              ...
              <?php $url=$this->general->create_custom_link( $sponsitem['product_id'],$this->session->userdata(SESSION.'user_id'));?>
  
                <div class="error-message hidden" style="color:red"></div>
                 <a href="<?php echo  $url;?>" onClick="trackOutboundLink('<?php echo $url;?>')"><?php echo $url;?></a>
                  <div class="text-center">
                      <a href="#" data-productid="<?php echo $sponsitem['product_id'];?>" data-btntype="add" data-media="<?php echo $sponsitem['media'];?>" class="btn btn-success sendproposal" id="sponsorshipproposal_<?php  echo $sponsitem['product_id'] ?>">Send Proposal</a> 
                  <a href="#" data-productid="<?php echo $sponsitem['product_id'];?>" class="btn btn-primary sponsordetail" id="<?php echo $sponsitem['product_id'];?>_sponsordetailid" onClick="ga('send',  'event','sponsoritemdetail','click','<?php echo 'button_'.$sponsitem['product_id']?>')">Detail</a> 
                       <?php if((isset($sponsitem['bid_status'])) && ($sponsitem['bid_status']=='2') && ($sponsitem['draft_accept']=='0' || $sponsitem['draft_accept']=='')){
                        ?>
                        <a href="#" data-productid="<?php echo $sponsitem['product_id'];?>" data-bidid="<?php echo $sponsitem['bid_id']?>" class="btn btn-primary draftpopupbtn" id="<?php echo $sponsitem['product_id'];?>_sponsordetailid" >Send Draft</a>
                        <?php }
                        ?>
                  </div> 
              <!-- </hr> -->
                          ...
                          <?php }
                            ...
                            <?php 
                              ...
                              if(defined('YOUTULEEMEDIAID')):
                                ...
                                { ?>
                                   <div class="col-xs-1 smedia hidden" id="vinemedia"><a data-productid="<?php echo $sponsitem['product_id'];?>"   data-mediaid="<?php echo YOUTULEEMEDIAID?>" href="#" data-medianame="vine" class="btn btn-block mediabrand btn-success"><i class="fa fa-vine "></i></a></div>
                          <?php }
                              endif;
                            if(defined('TUMBLRMEDIAID')):
                              if(in_array(TUMBLRMEDIAID,$usermedia))
                              { ?>
                                <div class="col-xs-1 smedia hidden" id="tumblrmedia"><a data-productid="<?php echo $sponsitem['product_id'];?>"  data-mediaid="<?php echo TUMBLERMEDIAID?>" href="#" data-medianame="tumblr" class=" mediabrand btn btn-block btn-info btn-tumb"><i class="fa fa-tumblr "></i></a></div>
                        <?php }
                            endif;
                              ?>
                  ...
                  Sponsored content must stay up for at least six months.</p>
                    ...
                    <div class="body">
                       ...
                       <div class=" col-sm-12 bottom_content">
                            <div class="col-sm-12">
                             <div class="error-message hidden" id="proposal_errpop" style="color:red; font-size:12px;"></div>
                                <button class="btn btn-success" id="submitproposal"><div class="btn-img" style="float:left">
                        ...
                        <?php }
                          ...
                          if(defined('YOUTULEEMEDIAID')):
                                if(!in_array(YOUTULEEMEDIAID,$usermedia))
                                { ?>
                                  <a href="<?php echo $vine_url;?>" id="connectvine" class="btn btn-block medianotconnected btn-success hidden"><i class="fa fa-vine "></i></a>
                          <?php }
                          endif;
                          if(defined('TUMBLRMEDIAID')):
                                if(!in_array(TUMBLRMEDIAID,$usermedia))
