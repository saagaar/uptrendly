...
?>
  ...
  <?php  if(defined('YOUTUBEMEDIAID') && array_key_exists(YOUTUBEMEDIAID,$media) &&  (in_array(YOUTUBEMEDIAID,$mediaassoc))):  ?>                           
    ...
    <div class="text-left">
    <span class="vw"> <span class="vw_ttl">Reach</span> <span class="vw_cnt"><?php echo $media[INSTAGRAMMEDIAID]->total_reach?></span> </span>
	...
	<div class="text-left">
          <span class="vw"> <span class="vw_ttl">Reach</span> <span class="vw_cnt"><?php echo $media[FACEBOOKMEDIAID]->total_reach?></span> </span>
  ...
  <div class="tbl_sec" style="padding:10px;">
      ...
      <h4 class="col-xs-6">Profession: <b><?php echo $user_info['basicinfo']['profession_name'];?></b></h4>
