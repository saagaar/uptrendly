...
<div class="shipping_detail">
	<div class="shipping_detail_card">
		...
		$amount=isset($payamount)?$payamount:$amount='0';
	 	
	 	
	 		$taxableamount=($tax/100)*$amount;
	 
		if($tax!=0)
		{?>
		<div class='alert alert-warning text-error'>You are suspected for a tax of <?php echo DEFAULT_CURRENCY_SIGN.' '. $taxableamount;?> additionally!</div>
	<?php
		}
