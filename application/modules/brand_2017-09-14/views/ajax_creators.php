...
<div class="main-filter m-0"><!-- <form> -->
  <div class="capm_type">
    <section class="plan">
      ...
      <label class="four col" for="campaign_normal"><span>Normal / Standard<br>
        Campaign</span></label>
...
else
{
  ...
  <div class="costgroup text-right <?php echo $budgetclass;?>" id="budget">
    <div class="btn btn-danger ps-15 navbar-main" style="width:400px;">
      <div class="row"> <span class="col-xs-5">
